      ...
      <div className="grid grid-cols-calendar place-content-center place-items-center gap-0.5">
        <div className="row-start-1 row-span-3 flex flex-col items-center gap-1 self-start">
          <button
            ...
            className="rounded-full bg-secondary-light px-3 py-1 text-sm text-primary-contrast whitespace-nowrap text-center hover:text-secondary-light hover:bg-primary-contrast border-solid border-2 hover:scale-105"
          >
            Min fraværsoversikt
          </button>
          <button
